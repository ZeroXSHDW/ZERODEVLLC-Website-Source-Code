...
const serviceFrameworkMap = [
  ...
  ['Compliance readiness', ['NIST SP 800-53 Rev. 5', 'NIST SP 800-171 / 800-171A', 'ISO/IEC 27001:2022'], 'Which requirement applies, what evidence is expected, and who owns the control or exception?', 'Readiness mapping is not certification, accreditation, clearance, legal advice, or regulator approval.'],
