...
const frameworks = [
  ...
  ['NIST SP 800-171', 'Discuss protection of controlled information in applicable nonfederal systems.', 'Applicability and contractual requirements must be confirmed for each engagement.'],
