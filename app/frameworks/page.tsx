...
const frameworks = [
  ...
  ['NIST SP 800-53 Rev. 5', 'NIST', 'Rev. 5 / Release 5.2.0 patch noted', 'Map security and privacy control families to systems, owners, and evidence.', 'Control presence must be verified in the relevant system and scope.', 'NIST SP 800-53 Rev. 5', 'https://csrc.nist.gov/pubs/sp/800/53/r5/upd1/final'],
  ...
  ['NIST SP 800-171 / 800-171A', 'NIST', 'R3 public-comments draft linked; confirm current published text', 'Discuss protection and assessment of controlled unclassified information in applicable nonfederal systems.', 'Applicability, contract language, assessment method, and evidence expectations must be confirmed for each engagement.', 'NIST CUI publications', 'https://csrc.nist.gov/Projects/protecting-controlled-unclassified-information'],
  ['NIST SP 800-172 Rev. 3 / 800-172A Rev. 3', 'NIST', 'Rev. 3 / final May 2026', 'Frame enhanced CUI requirements and assessment procedures for critical programs and high-value assets when selected by the responsible federal agency.', 'Enhanced CUI requirements are contract- and mission-dependent; this reference does not create a certification, clearance, or federal authorization.', 'NIST SP 800-172 Rev. 3', 'https://csrc.nist.gov/pubs/sp/800/172/r3/final'],
  ['CISA Cross-Sector Cybersecurity Performance Goals', 'CISA', 'Current publisher release; recheck latest', 'Prioritize voluntary, high-impact cybersecurity practices for critical-infrastructure risk reduction and measurable improvement.', 'CPGs are an orientation and prioritization aid, not a universal compliance result, sector designation, or regulator determination.', 'CISA Cybersecurity Performance Goals', 'https://www.cisa.gov/cybersecurity-performance-goals'],
...
const serviceFrameworkMap = [
  ...
  ['Government and defense readiness', ['NIST Risk Management Framework (SP 800-37 Rev. 2)', 'NIST SP 800-171 / 800-171A', 'NIST SP 800-172 Rev. 3 / 800-172A Rev. 3'], 'Which mission, contract, system boundary, CUI category, and authorizing role define the actual requirement?', 'Reference alignment is not an authorization to operate, CMMC status, clearance, contract award, or government approval.'],
  ['Compliance readiness', ['NIST SP 800-53 Rev. 5', 'NIST Risk Management Framework (SP 800-37 Rev. 2)', 'NIST SP 800-171 / 800-171A', 'NIST SP 800-172 Rev. 3 / 800-172A Rev. 3', 'ISO/IEC 27001:2022'], 'Which requirement applies, what evidence is expected, and who owns the control or exception?', 'Readiness mapping is not certification, accreditation, clearance, legal advice, or regulator approval.'],
  ...
  ['Incident readiness', ['NIST SP 800-61 Rev. 3', 'NIST CSF 2.0', 'CISA Cross-Sector Cybersecurity Performance Goals', 'NCSC Cyber Assessment Framework 4.0'], 'What roles, decisions, communications, evidence boundaries, and lessons must be practiced?', 'A readiness exercise is not live incident response, attribution, or a regulator decision.'],
] as const;
