...
const serviceFrameworkMap = [
  ...
  ['Government and defense readiness', ['NIST Risk Management Framework (SP 800-37 Rev. 2)', 'NIST SP 800-171 Rev. 3 / 800-171A Rev. 3', 'NIST SP 800-172 Rev. 3 / 800-172A Rev. 3'], 'Which mission, contract, system boundary, CUI category, and authorizing role define the actual requirement?', 'Reference alignment is not an authorization to operate, CMMC status, clearance, contract award, or government approval.'],
  ['Compliance readiness', ['NIST SP 800-53 Rev. 5', 'NIST Risk Management Framework (SP 800-37 Rev. 2)', 'NIST SP 800-171 Rev. 3 / 800-171A Rev. 3', 'NIST SP 800-172 Rev. 3 / 800-172A Rev. 3', 'ISO/IEC 27001:2022'], 'Which requirement applies, what evidence is expected, and who owns the control or exception?', 'Readiness mapping is not certification, accreditation, clearance, legal advice, or regulator approval.'],
