...
const serviceFrameworkMap = [
  ...
  ['Vendor due diligence', ['NIST SP 800-161 Rev. 1', 'NIST CSF 2.0', 'CIS Controls v8.1', 'EU NIS2 Directive (EU) 2022/2555', 'EU DORA Regulation (EU) 2022/2554', 'EU GDPR Regulation (EU) 2016/679'], 'Does the supplier evidence fit the service, data, access, incident, concentration, exit, and applicable regulatory relationship?', 'A questionnaire or reference map is not supplier assurance, a regulatory determination, or a procurement decision.'],
  ['Government and defense readiness', ['NIST Risk Management Framework (SP 800-37 Rev. 2)', 'NIST SP 800-171 Rev. 3 / 800-171A Rev. 3', 'NIST SP 800-172 Rev. 3 / 800-172A Rev. 3', 'EU NIS2 Directive (EU) 2022/2555', 'EU Critical Entities Resilience Directive (EU) 2022/2557'], 'Which mission, contract, system boundary, CUI category, critical-entity context, and authorizing role define the actual requirement?', 'Reference alignment is not an authorization to operate, CMMC status, clearance, contract award, critical-entity designation, or government approval.'],
  ['Compliance readiness', ['NIST SP 800-53 Rev. 5', 'NIST Risk Management Framework (SP 800-37 Rev. 2)', 'NIST SP 800-171 Rev. 3 / 800-171A Rev. 3', 'NIST SP 800-172 Rev. 3 / 800-172A Rev. 3', 'ISO/IEC 27001:2022', 'EU NIS2 Directive (EU) 2022/2555', 'EU DORA Regulation (EU) 2022/2554', 'EU GDPR Regulation (EU) 2016/679', 'EU Cyber Resilience Act (EU) 2024/2847'], 'Which requirement applies, what evidence is expected, which legal or supervisory role is relevant, and who owns the control or exception?', 'Readiness mapping is not certification, accreditation, clearance, legal advice, conformity assessment, or regulator approval.'],
