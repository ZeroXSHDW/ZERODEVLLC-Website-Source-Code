...
const decisionMatrix = [
  ...
  ['06', 'Compliance readiness', 'What requirement applies, what evidence exists, and what remains to be addressed?', 'Control map, applicability decision, owner, gap, exception, and review date', 'Assurance and control owner', 'Applicable contract, framework, jurisdiction, control owner, and evidence boundary; confirm CUI contract, system boundary, assessment method, and responsible authority when applicable'],
...
const serviceBriefs = [
  ...
  },
  {
    ...
    gate: 'Applicable contract, framework, jurisdiction, control owner, evidence boundary, and assessment objective; where CUI is in scope, confirm the contract, system boundary, assessment method, and responsible authority.',
    evidence: 'Applicable requirement or contract, jurisdiction, control register, evidence owner, implementation state, exception record, and the CUI applicability decision where relevant.',
    verification: 'Confirm applicability, map the requirement to evidence and control state, record limitations, and refer certification or regulatory questions appropriately; do not infer CUI status from a framework name alone.',
