...
export function ViewerActionButtons({
  ...
  return (
    <div className="fixed bottom-4 right-4 z-30 flex gap-3">
      ...
      >
        <Info
          className={`${iconSize} transition-transform group-hover:rotate-12`}
        />
      ...
      >
        <Activity
          className={`transition-transform ${iconSize} group-hover:scale-110`}
        />
      ...
      >
        <Download
          className={`${iconSize} transition-transform group-hover:translate-y-[-2px]`}
        />
