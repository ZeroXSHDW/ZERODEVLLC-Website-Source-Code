      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10 bg-white/5">
            <h3 id="controls-title" className="text-white font-semibold flex items-center gap-2">
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-5 bg-gradient-to-br from-white/5 to-transparent">
              {activeTab === 'camera' && (
                <CameraPanel onCameraPreset={onCameraPreset} onResetView={onResetView} />
              )}
              ...
              {activeTab === 'lod' && currentSettings && (
                <LODPanel currentSettings={currentSettings} onLodChange={onLodChange} />
              )}

              {activeTab === 'upload' && <UploadPanel onFileUpload={onFileUpload} />}

              {activeTab === 'screenshot' && <ExportPanel onScreenshot={onScreenshot} />}
            </div>
          </div>
        </motion.div>
      )}
