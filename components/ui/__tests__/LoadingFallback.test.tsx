...
describe('LoadingFallback', () => {
  ...
  it('renders loading animation', () => {
    ...
    const loadingContainer = document.querySelector('.relative.z-10.text-center');
  ...
  it('renders loading animation elements', () => {
    ...
    const statusIndicators = document.querySelectorAll('.bg-blue-500, .bg-purple-500, .bg-pink-500');
