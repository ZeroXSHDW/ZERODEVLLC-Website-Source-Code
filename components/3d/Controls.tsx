...
const ControlsComponent = forwardRef<OrbitControlsImpl, ControlsProps>(function Controls(
  ...
  return (
    <OrbitControls
      ...
      autoRotateSpeed={performanceMode ? CONTROLS_CONFIG.autoRotateSpeed * 0.5 : CONTROLS_CONFIG.autoRotateSpeed}
