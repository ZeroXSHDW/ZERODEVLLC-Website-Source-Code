...
requireText("app/layout.tsx", layout, "public-sector programs, military and defense suppliers");
requireText("app/layout.tsx", layout, "penetration-testing frameworks");
...
requireText("app/methodology/page.tsx", methodologyPage, "The public starter is not an authorization");
requireText("app/methodology/page.tsx", methodologyPage, "Permitted methods");
...
requireText("app/home-status.tsx", homeStatus, "document.addEventListener('pointerdown', closeOnPointerDown)");
requireText("app/home-status.tsx", homeStatus, "document.body.style.overflow = 'hidden'");
requireText("app/home-status.tsx", homeStatus, "ref={headerRef}");
...
requireText("app/page.tsx", page, "systems.map((system)");
requireText("app/page.tsx", page, "terminalSystemKey(system.name)");
requireText("app/page.tsx", page, "system.external ? 'LINK' : 'HOLD'");
requireText("app/page.tsx", page, "system.mode.toLowerCase()");
