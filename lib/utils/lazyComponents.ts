...
export const LazyControlsPanel = loadable(
  () =>
    import("../../components/ui/ControlsPanel").then((module) => ({
      default: module.ControlsPanel,
    })),
  {
...
export const LazyKeyboardShortcutsHelp = loadable(() =>
  import("../../components/ui/KeyboardShortcutsHelp").then((module) => ({
...
export const LazyModelInfo = loadable(
  () =>
    import("../../components/ui/ModelInfo").then((module) => ({
      default: module.ModelInfo,
    })),
  {
    fallback: React.createElement(
      "div",
...
export const LazyMobileGestureHelp = loadable(() =>
  import("../../components/ui/MobileGestureHelp").then((module) => ({
    default: module.MobileGestureHelp,
  })),
);
...
export const LazyExportDialog = loadable(
  () =>
    import("../../components/ui/ExportDialog").then((module) => ({
...
export const LazyMobileControls = loadable(() =>
  import("../../components/ui/MobileControls").then((module) => ({
    default: module.MobileControls,
  })),
);
